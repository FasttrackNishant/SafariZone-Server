...
ALTER TABLE Users ADD HasAgreedTerms BIT NOT NULL DEFAULT 0;
ALTER TABLE Users ADD TermsAgreedOn DATETIME NULL;
ALTER TABLE Users ADD TermsVersion NVARCHAR(20) NULL;
ALTER TABLE USERs Add Salt NVARCHAR(128)  NULL ;
